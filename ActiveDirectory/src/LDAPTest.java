...
public class LDAPTest {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapAdServer = "ldap://spectraeastnj.com:389";
        final String ldapSearchBase = "dc=spectraeastnj,dc=spectraeastnj.com,dc=com";
        final String _domain  = "spectraeastnj.com";
        final String ldapUsername = "ssoldaptest" + "@" + _domain;
        final String ldapPassword = "Likely!2";
        
        final String ldapAccountToLookup = "mdarretta";
